...
namespace aRandomKiwi.RimThemes
{
    ...
    static class Themes
    {
        static Themes()
        {
            ...
            {
                new FOI("DefaultBarBgTex",NPS),new FOI("BarFullTexHor",NPS),new FOI("CheckboxOnTex"), new FOI("CheckboxOffTex"), new FOI("CheckboxPartialTex"), new FOI("RadioButOnTex",NPS),
                new FOI("RadioButOffTex",NPS),new FOI("FillArrowTexRight",NPS),new FOI("FillArrowTexLeft",NPS),new FOI("ShadowAtlas",NPS),
                new FOI("ButtonBGAtlas",NPS), new FOI("ButtonBGAtlasMouseover",NPS), new FOI("ButtonBGAtlasClick",NPS), new FOI("FloatRangeSliderTex",NPS), new FOI("LightHighlight"),
            ...
            fieldsOfInterestColor["Widgets"] = new List<FOI>() {
                new FOI("WindowBGBorderColor",NPS), new FOI("WindowBGFillColor"), new FOI("MenuSectionBGFillColor",NPS), new FOI("MenuSectionBGBorderColor",NPS), new FOI("TutorWindowBGFillColor",NPS),
                ...
                new FOI("NormalOptionColor"),new FOI("MouseoverOptionColor"),new FOI("SeparatorLineColor",NPS), new FOI("SeparatorLabelColor")
            };
            ...
            fieldsOfInterestColor["HealthUtility"] = new List<FOI>() { new FOI("ImpairedColor"), new FOI("SlightlyImpairedColor"), new FOI("DarkRedColor"),
            ...
            {
                new FOI("RedReadable"), new FOI("NameColor"), new FOI("CurrencyColor"),new FOI("DateTimeColor"),new FOI("FactionColor_Ally"),
        ...
        private static void loadThemesInFolder(string modID,string themesDir, bool prefix)
        {
            ...
            try
            {
                foreach (var dir in folders)
                {
                    ...
                    string animatedPath = dir + Path.DirectorySeparatorChar + "Textures" + Path.DirectorySeparatorChar + "UI_BackgroundMain.BGPlanet.ogv";
                    if (File.Exists(animatedPath))
                    {
                        try
                        {
                            //Converting absolute url to URI
                            var uri = new System.Uri(animatedPath);
                            var uriAnimatedPath = uri.AbsoluteUri;
                            DBAnimatedBackground[themeID] = new WWW(uriAnimatedPath);
                            Themes.LogMsg("Found and loading animated background "+uriAnimatedPath);
                        }
                        catch(Exception e)
                        {
        ...
        */
        ...
        //Animated background
        static public Dictionary<string, WWW> DBAnimatedBackground = new Dictionary<string, WWW>();
