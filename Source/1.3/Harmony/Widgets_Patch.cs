...
namespace aRandomKiwi.RimThemes
{
    ...
    class ButtonTextWorker_Patch
    {
        ...
        [HarmonyPrefix]
        static bool Prefix(ref Widgets.DraggableResult __result, Rect rect, string label, bool drawBackground, bool doMouseoverSound, Color textColor, bool active, bool draggable)
        {
    ...
    {
        [HarmonyPrefix]
        static bool Prefix(ref bool __result, Rect rect, string label, float barPercent = 0f, float textLeftMargin = -1f, SoundDef mouseoverSound = null, Vector2 functionalSizeOffset = default(Vector2))
        {
