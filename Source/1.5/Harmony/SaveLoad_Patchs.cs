...
namespace aRandomKiwi.RimThemes
{
    ...
    [HarmonyPatch(typeof(LongEventHandler), nameof(LongEventHandler.QueueLongEvent), new Type[] { typeof(Action), typeof(string), typeof(bool), typeof(Action<Exception>), typeof(bool), typeof(Action) }), StaticConstructorOnStartup]
    public class LongEventHandler_QueueLongEvent3_Patch
    {
        public static void Prefix(Action action, string textKey, bool doAsynchronously, Action<Exception> exceptionHandler, bool showExtraUIInfo = true, Action callback = null)
        {
