...
namespace aRandomKiwi.RimThemes
{
    ...
    /*[HarmonyPatch(typeof(WorldGenerator), nameof(WorldGenerator.GenerateFromScribe)), StaticConstructorOnStartup]
    public class WorldGenerator_Terrain_GenerateFromScribe_Patch
    {
        [HarmonyPostfix]
        public static void Prefix(WorldGenerator __instance, string seed)
        {
    ...
    [HarmonyPatch(typeof(WorldGenerator), nameof(WorldGenerator.GenerateFromScribe)), StaticConstructorOnStartup]
    public class WorldGenerator_GenerateWithoutWorldData_Patch
    {
        [HarmonyPostfix]
        public static void Prefix(WorldGenerator __instance, string seed)
        {
    ...
    [HarmonyPatch(typeof(LongEventHandler), nameof(LongEventHandler.QueueLongEvent), new Type[] { typeof(IEnumerable), typeof(string), typeof(Action<Exception>), typeof(bool), typeof(bool) }), StaticConstructorOnStartup]
    public class LongEventHandler_QueueLongEvent_Patch
    {
        public static void Prefix(IEnumerable action, string textKey, Action<Exception> exceptionHandler = null, bool showExtraUIInfo = true, bool forceHideUI = false)
        {
    ...
    [HarmonyPatch(typeof(LongEventHandler), nameof(LongEventHandler.QueueLongEvent), new Type[] { typeof(Action), typeof(string), typeof(string), typeof(bool), typeof(Action<Exception>), typeof(bool), typeof(bool) }), StaticConstructorOnStartup]
    public class LongEventHandler_QueueLongEvent2_Patch
    {
        public static void Prefix(Action preLoadLevelAction, string levelToLoad, string textKey, bool doAsynchronously, Action<Exception> exceptionHandler, bool showExtraUIInfo = true, bool forceHideUI = false)
        {
    ...
    [HarmonyPatch(typeof(LongEventHandler), nameof(LongEventHandler.QueueLongEvent), new Type[] { typeof(Action), typeof(string), typeof(bool), typeof(Action<Exception>), typeof(bool), typeof(bool), typeof(Action) }), StaticConstructorOnStartup]
    public class LongEventHandler_QueueLongEvent3_Patch
    {
        public static void Prefix(Action action, string textKey, bool doAsynchronously, Action<Exception> exceptionHandler, bool showExtraUIInfo = true, bool forceHideUI = false, Action callback = null)
        {
