...
namespace aRandomKiwi.RimThemes
{
    ...
    static class Themes
    {
        static Themes()
        {
            ...
            fieldsOfInterestTex["TrainingCardUtility"] = new List<FOI>() { new FOI("LearnedTrainingTex"), new FOI("LearnedNotTrainingTex") };
            ...
            fieldsOfInterestTex["TexButton"] = new List<FOI>() {
                new FOI("Delete"),new FOI("CloseXBig"),new FOI("CloseXSmall"),new FOI("NextBig"),new FOI("ReorderUp"),new FOI("ReorderDown"),new FOI("Plus"),new FOI("Minus"),
                ...
                new FOI("OpenInspector"),new FOI("OpenInspectSettings"),new FOI("GodModeEnabled"),new FOI("GodModeDisabled"),
                ...
                new FOI("Play"),new FOI("Stop"),new FOI("RangeMatch"),new FOI("CenterOnPointsTex"),new FOI("CurveResetTex"),new FOI("QuickZoomHor1Tex"),
            ...
            {
                new FOI("ColorBaseNeutral",NPS), new FOI("ColorBaseHostile"), new FOI("ColorBasePrisoner",NPS),new FOI("ColorColony",NPS),new FOI("ColorWildMan",NPS)
            };
            ...
            fieldsOfInterestColor["NeedsCardUtility"] = new List<FOI>() { new FOI("MoodColor"), new FOI("MoodColorNegative"), new FOI("NoEffectColor", NPS),
            };
